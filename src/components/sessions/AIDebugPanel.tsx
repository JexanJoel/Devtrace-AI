...
// ─── FIX: Removed `group` class and opacity-0 hide — copy button always visible ─
const CodeBlock = ({ code }: { code: string }) => {
  ...
  return (
    <div className="relative">
      <pre className="bg-gray-900 rounded-xl p-4 pr-16 text-xs text-gray-300 overflow-x-auto whitespace-pre-wrap font-mono max-h-64 overflow-y-auto select-text">
        <code>{code}</code>
      </pre>
      <button
        onClick={copy}
                  ...
                  {logAnalysis && (
                    <div className="animate-slide-up space-y-6">
                      <div className="bg-red-50 dark:bg-red-950/50 border border-red-100 dark:border-red-900/50 rounded-2xl p-5">
                        ...
                        <p className="text-sm text-gray-800 dark:text-gray-200 font-bold leading-relaxed">{logAnalysis.root_cause}</p>
                      </div>
                      <div className="space-y-3">

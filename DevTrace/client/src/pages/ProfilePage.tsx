// ProfilePage — edit profile info and upload avatar
  ...
  return (
    <DashboardLayout title="Profile">
      <div className="max-w-2xl space-y-6">
        ...
        {/* Profile info */}
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h2 className="font-bold text-gray-900 mb-5">Personal Info</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={user?.email ?? ''}
                  disabled
                  className="w-full border-2 border-gray-100 text-gray-400 bg-gray-50 rounded-xl pl-10 pr-4 py-2.5 text-sm cursor-not-allowed"
                />
              </div>
